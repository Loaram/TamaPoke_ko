...
story.extend(
    [
        ...
        p("올바른 작별과 다음 알", H2),
        p("평소 이로치 알의 기본 확률은 <b>1/48</b>입니다. 최종 진화 후 1일 조건을 채우고 정상적으로 작별하면 다음 알은 <b>1/24</b>부터 시작합니다. 돌봄 연속일수와 유대 보너스까지 좋으면 최고 <b>1/10</b>까지 올라갑니다.", SAFE),
...
story.extend(
    [
        ...
        p("기술 카드에서 타입, 분류, 위력과 명중률을 확인하세요. 상대 타입에 잘 맞는 기술과 상태 기술을 함께 준비하면 체육관과 근거리 배틀에 대응하기 쉽습니다.", CALLOUT),
    ]
)
page_break(story)
