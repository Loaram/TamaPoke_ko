...
The APK is written to `build/android/TamaPoke-ko.1.1.3-Android-Full-debug.apk`.
...
The output is `build/android/TamaPoke-ko.1.1.3-WearOS-GalaxyWatch4-9-debug.apk`.
