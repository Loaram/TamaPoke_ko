...
The APK is written to `build/android/TamaPoke-ko.1.1.4-Android-Full-debug.apk`.
...
The output is `build/android/TamaPoke-ko.1.1.4-WearOS-GalaxyWatch4-9-debug.apk`.
