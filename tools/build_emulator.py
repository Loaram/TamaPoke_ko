...
def main():
    ...
    variants.add_argument('--forms-beta',action='store_true',help='isolated form-system test save with six level-80 Pokemon')
    ...
    if a.forms_beta: flags.append('-DTAMAPOKE_FORMS_BETA=1')
