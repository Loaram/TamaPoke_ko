...
for test in ['reset','daily_egg','sprite_layout','bond','android_udp','shared_energy','collection_lock','capture_dex','recovery_clock','modal_safety','swap_recovery','trade','trade_ui','korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
...
print('PASS: '+(a.only or '66 runtime suites including reset, daily eggs, sprite layout, bond, Android UDP transport, shared energy and save recovery'))
