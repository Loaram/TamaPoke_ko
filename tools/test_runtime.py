...
for test in ['korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
             ...
             'touch','swipe','starter','release','joy','wild','explore','wild_result','android_lifecycle','nvs_file','streak_persistence','dex_rewards','forms','forms_ui','active_swap','form_moves','daily_rewards','daily_rewards_ui','box_pages','ending_recovery','box_direct','box_sort','revive','companion_growth']:
...
print('PASS: '+(a.only or '51 runtime suites including explicit Explore results and all 3.3.0 systems'))
