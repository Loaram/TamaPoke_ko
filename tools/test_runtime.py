...
for test in ['recovery_clock','modal_safety','swap_recovery','trade','trade_ui','korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
    ...
    if test in ('modal_safety','swap_recovery','trade_ui','lan','hit','touch','swipe','starter','release','joy','explore','wild_result','battle_reserves','forms_ui','gyms_new','active_swap','form_moves','daily_rewards_ui','box_pages','box_direct','box_sort','companion_growth'):
...
print('PASS: '+(a.only or '58 runtime suites including recovery clocks, modal safety, swap recovery and durable individual transfer'))
