...
for test in ['shared_energy','collection_lock','capture_dex','recovery_clock','modal_safety','swap_recovery','trade','trade_ui','korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
...
print('PASS: '+(a.only or '61 runtime suites including shared energy, collection locks, capture bonus and save recovery'))
