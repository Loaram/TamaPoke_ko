...
for test in ['korean','i18n','label','save','upgrade','link','balance','moves','dexdata','eevee','branch','full_dex','full_shiny','hit','starter','release']:
...
print('PASS: Korean/i18n/label/save/upgrade/link/balance/moves/dexdata/eevee/branch/full_dex/full_shiny/hit/starter/release runtime suites')
