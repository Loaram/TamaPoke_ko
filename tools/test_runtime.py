...
for test in ['korean','i18n','label','save','savetransfer','upgrade','link','linkudp','lan','balance','retire','moves','dexdata','eevee','branch','region','full_dex','full_shiny','hit','starter','release']:
    ...
    if test in ('lan','hit','starter','release'):
...
print('PASS: Korean/i18n/label/save/savetransfer/upgrade/link/linkudp/lan/balance/retire/moves/dexdata/eevee/branch/region/full_dex/full_shiny/hit/starter/release runtime suites')
