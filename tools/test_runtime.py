...
for test in ['capture_dex','recovery_clock','modal_safety','swap_recovery','trade','trade_ui','korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
...
print('PASS: '+(a.only or '59 runtime suites including collection capture bonus, recovery clocks and durable individual transfer'))
