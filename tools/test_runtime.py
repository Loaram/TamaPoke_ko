...
for test in ['korean','i18n','label','save','upgrade','link','balance','moves','full_dex','hit','starter','release']:
...
print('PASS: Korean/i18n/label/save/upgrade/link/balance/moves/full_dex/hit/starter/release runtime suites')
