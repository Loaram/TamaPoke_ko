...
for test in ['korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
             ...
             'touch','swipe','starter','release','joy','wild','explore','android_lifecycle','forms','forms_ui','active_swap','form_moves','daily_rewards','daily_rewards_ui','box_pages','ending_recovery','box_direct','box_sort','revive','companion_growth']:
...
print('PASS: '+(a.only or '47 runtime suites including companion growth, IV display and all 3.1.0 systems'))
