...
for test in ['korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
             ...
             'touch','swipe','starter','release','joy','wild','explore','android_lifecycle','nvs_file','streak_persistence','dex_rewards','forms','forms_ui','active_swap','form_moves','daily_rewards','daily_rewards_ui','box_pages','ending_recovery','box_direct','box_sort','revive','companion_growth']:
    ...
    if test in ('lan','hit','touch','swipe','starter','release','joy','explore','forms_ui','gyms_new','active_swap','form_moves','daily_rewards_ui','box_pages','box_direct','box_sort','companion_growth'):
...
print('PASS: '+(a.only or '50 runtime suites including collectible Dex rewards and all 3.2.0 systems'))
