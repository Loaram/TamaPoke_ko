...
for test in ['korean','i18n','label','save','upgrade','link','linkudp','lan','balance','retire','moves','dexdata','eevee','branch','region','full_dex','full_shiny','hit','starter','release']:
...
print('PASS: Korean/i18n/label/save/upgrade/link/linkudp/lan/balance/retire/moves/dexdata/eevee/branch/region/full_dex/full_shiny/hit/starter/release runtime suites')
