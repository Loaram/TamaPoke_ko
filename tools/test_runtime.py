...
for test in ['korean','i18n','label','save','savetransfer','upgrade','link','linkudp',
             ...
             'touch','swipe','starter','release','joy','wild','explore','android_lifecycle','forms','forms_ui','active_swap','form_moves','daily_rewards','daily_rewards_ui','box_pages','ending_recovery']:
    ...
    if test in ('lan','hit','touch','swipe','starter','release','joy','explore','forms_ui','gyms_new','active_swap','form_moves','daily_rewards_ui','box_pages'):
...
print('PASS: '+(a.only or '43 runtime suites including durable farewell recovery and all 3.0.0 systems'))
