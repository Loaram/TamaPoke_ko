...
- Build/emulator/web checks have passed for ko.1.1.5. Hardware, Android device-time behavior, the 24-hour farewell boundary and Android-to-hardware LAN tests remain unverified until actual results are recorded. See the hardware test issue template and `docs/HARDWARE_TEST.ko.md`.
...
- Every numbered GitHub release must attach the unchanged Watch4-9 installation guide from `docs/guides/TamaPoke-Galaxy-Watch4-9-Install-Guide-KO.pdf`, named `TamaPoke-<version>-Galaxy-Watch4-9-Install-Guide-KO.pdf`, and include its SHA-256 in `SHA256SUMS.txt`. This is a required public asset alongside the Android APK, Wear OS APK and ESP32 installer ZIP.
