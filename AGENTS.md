...
- Build/emulator/web checks have passed for ko.1.1.1. Hardware and Android-to-hardware LAN tests remain unverified until actual results are recorded. See the hardware test issue template and `docs/HARDWARE_TEST.ko.md`.
