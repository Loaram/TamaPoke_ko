...
ko.1.0.2는 성장·수면 밸런스 수정판입니다. ko.1.0.1 확인창 수정 기록과 이전 3.11-ko.1 기록은 `docs/qa/`에 보존합니다.
...
|---|---:|---:|
| 프로그램 플래시 | 1,808,375 B | 1,849,991 B |
| 전역 RAM | 66,116 B | 66,884 B |

한국어 앱 파일은 1,850,144바이트입니다. 프로그램 영역 3,145,728바이트의 58.8%를 사용합니다. 동적 메모리의 실기 최대 사용량은 측정하지 않았습니다.
