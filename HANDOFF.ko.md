...
ko.1.0.3은 2일 작별 주기에 맞춘 성장 수정판입니다. 이전 버전의 기록은 `docs/qa/`에 보존합니다.
...
한국어 앱 파일은 1,850,064바이트입니다. 프로그램 영역 3,145,728바이트의 58.8%를 사용합니다. 동적 메모리의 실기 최대 사용량은 측정하지 않았습니다.
