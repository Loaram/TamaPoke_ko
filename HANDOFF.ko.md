...
ko.1.0.4는 꼬시레의 레벨 1 기술과 전 종의 빈 기술 방지 처리를 보완한 수정판입니다. 이전 버전의 기록은 `docs/qa/`에 보존합니다.
...
ko.1.0.4 한국어 앱 파일은 1,850,224바이트입니다. 스케치는 프로그램 영역 3,145,728바이트의 58%를 사용하며 전역 RAM은 66,884바이트입니다. 동적 메모리의 실기 최대 사용량은 측정하지 않았습니다.
